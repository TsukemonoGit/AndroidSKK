...
class SKKPrefs(context: Context) {
    ...
    var candidatesNormalLines: Int
        ...
        set(value) =
                prefs.edit { putInt(res.getString(R.string.pref_candidates_normal_lines), value) }

    var candidatesEmojiLines: Int
        get() = prefs.getInt(res.getString(R.string.pref_candidates_emoji_lines), 4)
        set(value) =
                prefs.edit { putInt(res.getString(R.string.pref_candidates_emoji_lines), value) }

    // 辞書管理
    val defaultDictOrder = "ユーザー辞書/${res.getString(R.string.dict_name_user)}/"
    var dictOrder: String
        get() =
                prefs.getString(res.getString(R.string.pref_dict_order), defaultDictOrder)
                        ?: defaultDictOrder
    ...
    var useCandidatesView: Boolean
        ...
        set(value) =
                prefs.edit { putBoolean(res.getString(R.string.pref_use_candidates_view), value) }
    ...
    var useSoftCancelKey: Boolean
        ...
        set(value) =
                prefs.edit { putBoolean(res.getString(R.string.pref_use_soft_cancel_key), value) }
    ...
    var changeShift: Boolean
        ...
        set(value) =
                prefs.edit { putBoolean(res.getString(R.string.pref_exchange_shift_kana), value) }
    ...
    var originalColor: Boolean
        ...
        set(value) =
                prefs.edit { putBoolean(res.getString(R.string.pref_ignore_high_contrast), value) }
    ...
    var keyWidthQwertyZoom: Int
        ...
        set(value) =
                prefs.edit { putInt(res.getString(R.string.pref_key_width_qwerty_zoom), value) }
    ...
    var keyCenterPort: Float
        get() = prefs.getFloat(res.getString(R.string.pref_key_center_port), 0.5f).coerceIn(0f, 1f)
        set(value) =
                prefs.edit {
    ...
    var keyCenterLand: Float
        get() = prefs.getFloat(res.getString(R.string.pref_key_center_land), 0.5f).coerceIn(0f, 1f)
        set(value) =
                prefs.edit {
    ...
    var keyWidthLand: Int
        get() {
            ...
            return prefs.getInt(res.getString(R.string.pref_key_width_land), screenWidth * 3 / 10)
                    .coerceAtLeast(res.getDimensionPixelSize(R.dimen.keyboard_minimum_width))
        }
